...
시작 안내의 정책은 `usage-aware-2026-09-12`입니다. [정책 전문](POLICY.md)과 [업무별 예시](docs/use-cases.md)를 확인하세요. 모델 이름은 계정에서 지원하는지 확인한 뒤 선택하세요. 이 정책은 자동 모델 전환기, 사용량 강제 차단기 또는 사용량 절감 보증이 아닙니다.
